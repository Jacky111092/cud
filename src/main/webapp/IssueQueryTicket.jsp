...
<div class="bg" style= "margin-top:-40px">
  <div class="container">
    ...
    <hr>
    <form action="issueQueryTicket.do" method="post">
    <table>
    <tr>
    <td>
    <label><b>QueryId</b></label>
    <br>
    </td>
    <td>
    <label>${query.getQueryId()}</label>
    <br>
    </td>
    </tr>
    <tr>
  ...
  <br>
   ...
   <input type="hidden" value="${query.getQueryId()}" name="queryid"/>
