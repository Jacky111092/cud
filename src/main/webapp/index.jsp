...
<form action="customer.jsp" >
	  <div class="button login">
         <button><span>CUSTOMER</span> <i class="fa fa-check"></i></button>
      </div>
	</form>
  
  <form action="staff.jsp" >
	  <div class="button login">
        <button><span>STAFF</span> <i class="fa fa-check"></i></button>
      </div>
	</form>
    
<form action="adminlogin.jsp" >
	  <div class="button login">
         <button><span>ADMIN</span> <i class="fa fa-check"></i></button>
      </div>
	</form>
        ...
        <div class="row">
			...
			<div class="col-xs-6 col-sm-3 col-md-3">
                ...
                <div class="team boxed-grey">
                    <div class="inner">
						<h5>Abhay Tyagi</h5>
                        <div class="avatar"><img src="img/team/abhay.jpg" alt="" class="img-responsive img-circle" style="height:220px;width:250px" /></div>
