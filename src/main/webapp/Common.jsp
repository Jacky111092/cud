  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{Session::get('admin_data')['profile_picture']}}" class="img-circle elevation-2" onerror="this.src='/AdminUploads/profile_picture/profile_picture.jpg'" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block"><b>{{Session::get('admin_data')['username']}}</b></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="/all-client" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/add-campaign" class="nav-link">
                  <i class="fa fa-plus-circle nav-icon"></i>
                  <p>Add New Campaign</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/all-campaigns" class="nav-link">
                  <i class="fa fa-list-ul nav-icon"></i>
                  <p>All Campaigns</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/list-ready-to-live" class="nav-link">
                  <i class="fa fa-list-ul nav-icon"></i>
                  <p>Ready To Live</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/live-campaigns" class="nav-link">
                  <i class="fa fa-list-ul nav-icon"></i>
                  <p>Live Campaigns</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/vehicle-partner-registration" class="nav-link">
                  <i class="fa fa-user-plus nav-icon"></i>
                  <p>Add Vehicle Partner</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/all-vehicle-partners" class="nav-link">
                  <i class="fa fa-list-ul nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/add-wallet" class="nav-link">
                  <i class="fa fa-plus-circle nav-icon"></i>
                  <p>Add Wallet</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/wallet-list" class="nav-link">
                  <i class="fa fa-list-ul nav-icon"></i>
                  <p>Wallet List</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/add-vehicle" class="nav-link">
                  <i class="fa fa-plus nav-icon"></i>
                  <p>Add Vehicles</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="/all-vehicles" class="nav-link">
                  <i class="fa fa-list-ul nav-icon"></i>
                  <p>All Vehicles</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/all-requested-vehicles" class="nav-link">
                  <i class="fa fa-list-ul nav-icon"></i>
                  <p>New Requests</p>
                </a>
              </li>
