  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card card-primary">
        ...
        <form action="updateZone.do" class="frmBx" method="post" autocomplete="off">
<!--         <input type="hidden" name="_token" value="{{ csrf_token() }}">
 -->          <div class="card-body">
          <div class="row">
            <div class="col-12 col-md-6">
              <div class="form-group">
                <input type="hidden" id="zone_id" class="form-control" name="zone_id" placeholder="zone_id" value="${ZoneDetails.getZone_id()}">
              
                  <label for="zone_name">Zone Name</label>
                  <input type="text" class="form-control" name="zone_name" id="zone_name" value="${ZoneDetails.getZone_name()}">
              </div>
            </div>
            <div class="col-12 col-md-6">
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
              ...
              <tr>
				...
				<c:forEach items="${allZoneList}" var="allZone">
				<tr>
				<form action="editZone.do" class="frmBx" method="post">
				
                  <!-- <td>{{$i}}</td> -->

                  <td><input type="hidden" id="zone_id" class="form-control" name="zone_id" placeholder="zone_id" value="<c:out value="${allZone.getZone_id()}"/>">
 	                <c:out value="${allZone.getZone_id()}"/></td>
                  <td>
                   <c:out value="${allZone.getZone_name()}"/>
                  </td>
                  <td>
