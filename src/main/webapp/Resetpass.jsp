...
<div class="materialContainer">
   ...
   <div class="box">
	...
	<form action="updatepassword.do" onsubmit = "" method="post" class="modal-content animate">
      ...
      <div class="input">
       ...
       <div class="input">
         <input type="password" name="confpassword" id="pw" placeholder="Confirm Password">
         <span class="spin"></span>
      </div>
      
	
	  <div class="button login">
         <button><span>Reset</span> <i class="fa fa-check"></i></button>
      </div>
	</form>
                ...
                <div class="row wow zoomIn">
                    <div class="col-lg-12">
                        <div class="call-to-action text-center">
                            <p>âInsurance is a combination of caring, commitment and common senseâ</p>
