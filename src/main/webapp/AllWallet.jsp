          ...
          // edit the row
           ...
           <div class="card card-primary" style="width:100%;"> 
            <div class="card-header">
                <h3 class="card-title">List of All Campaigns</h3>
              </div>
             <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <c:forEach items="${allWalletList}" var="allWallet">
                  <c:choose>
                  <c:when test="${allCampaign.getCampaignId()==allWallet.getCampaign().getCampaignId()}">
                  
 	                <tr>
 	                <form action="editWalletForCampaign.do" class="frmBx" method="post">
 	                <td>
 	                <input type="hidden" id="campaignId" class="form-control" name="campaignId" placeholder="Campaign Id" value="<c:out value="${allWallet.getWalletId()}"/>">
 	               	<input type="hidden" id="walletId" class="form-control" name="walletId" placeholder="walletId" value="<c:out value="${allWallet.getWalletId()}"/>">
 	                
 	                <c:out value="${allWallet.getWalletId()}"/></td>
                        ...
                        <td name="campaign_name">
  	                    ...
  	                    <td name="no_of_vehicles"><c:out value="${allWallet.getPaid_amount()}"/></td>
