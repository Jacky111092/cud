...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body onload = "document.getElementById('id012').style.display='block'" style="width:auto;">
                    ...
                    <nav class="collapse navigation navbar-collapse navbar-right" role="navigation">
                        <ul id="nav" class="nav navbar-nav">
                           ...
                           <li><a href="#subscribe">Subscribe</a></li>
                            ...
                            <li><a href="#" onclick="document.getElementById('id012').style.display='block'" style="width:auto;">LOGIN</a></li>
                        </ul>
                    </nav>
                    <!-- /main nav -->
                </div>
...
<div class="materialContainer">
   ...
   <div class="box">
	...
	<form action="staffLogin.do" onsubmit = "return validateForm()" method="post" class="modal-content animate">
	     <p><font size="3" color="red">${invalidStaffMessage}</font></p>

      <div class="input">
         <input type="text" name="emailid" id="uid" placeholder="EmailId">
	...
	<form action = "loginpopup.html" method="post">

	  <div class="button login">
         <button><span>BACK</span> <i class="fa fa-check"></i></button>
      </div>
