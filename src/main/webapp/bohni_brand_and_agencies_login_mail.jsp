        ...
        <div class="row d-flex">
            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    ...
                    <form action="checkClientMailPass.do" class="frmBx" method="post" autocomplete="off">
                    <div class="row px-3"> <label class="mb-1">
                            <h6 class="mb-0 text-sm">Email Address</h6>
                        </label> <input class="mb-4" type="email" name=work_emailid placeholder="Enter a valid email address" required> </div>
                    <div class="row px-3"> <label class="mb-1">
