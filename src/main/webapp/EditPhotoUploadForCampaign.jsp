    ...
    <div class="col-md-12">
      <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Upload Photos of Vehicles for Live Campaign</h3>
        </div>
        <form action="updatePhotosOfCampaign.do" class="frmBx" method="post"  autocomplete="off" enctype="multipart/form-data">
          <div class="card-body">
          <div class="row">
           ...
           <div class="col-12 col-sm-4">
              <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="total_kms_ran" id="total_kms_ran" value="${campaignAndVehicle.getTotal_kms_ran()}" readonly="true">
              </div>
            </div>
            ...
            <div class="col-12 col-sm-4">
              <div class="form-group">
                ...
                <div class="select2-purple">
                   <select class="form-control select2" name="file_type" style="width: 100%;">
		                    <option selected="selected" disabled="disabled">Select File Type</option>
                  			
                  			<option value="Proof of Work 1">Proof of Work 1</option>
                  			<option value="Proof of Work 2">Proof of Work 2</option>
                  			<option value="Proof of Work 3">Proof of Work 3</option>
                  			<option value="Proof of Work 4">Proof of Work 4</option>
             ...
             <div class="col-12 col-sm-4">
              <div class="form-group">
                <label for="exampleInputFile">Photo Uploads</label>
