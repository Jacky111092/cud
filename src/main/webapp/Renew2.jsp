                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active"  style="background-image: url('img/b1.jpg')" >
                        <div class="carousel-caption">
                            ...
                            <h1 style="margin-bottom:20px"><center><b>Your  Policy</b></center></h1>                             
...
<c:forEach items="${Policy}" var="policy">
   ...
   <tr>
        ...
        <td> <c:out value="${policy.getPolicyId()}"/></td>
        <td> <c:out value="${policy.getPolicyName()}"/></td>
        <td> <c:out value="${policy.getStartdate()}"/></td>
        <td> <c:out value="${policy.getEnddate()}"/></td>
         <form action="renew1.do">
        <td>
        <select name="yo">
...
<input type = "submit" value="renew"/>
 ...
 <!-- <h1 style="margin-top:2%">Do you want to <b>RENEW?<b></h1>
<a href="quote2.html"><button class="button" style="margin-top:3%" >Yes</button>
<a href="home1exist.html"><button class="button" style="margin-top:3%" >No</button>
