                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active"  style="background-image: url('img/b1.jpg')" >
                        <div class="carousel-caption">
                          ...
                          <h1 style="margin-bottom:20px"><center><b>Policy Prices</b></center></h1>  
						<p style="margin-bottom:20px"><center><b>Company Name : </b> ${vehicleDetails.getCompanyName()}</center></p>  
                   <p style="margin-bottom:20px"><center><b>Vehicle Model : </b> ${vehicleDetails.getVehicleModel()}</center></p>   
                         <p style="margin-bottom:20px"><center><b>Registration Date : </b> ${rtoObject.getBuydate()}</center></p>  
