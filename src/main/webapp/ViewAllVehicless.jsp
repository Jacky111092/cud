             ...
             <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <c:forEach items="${allVehicleList}" var="allVehicle">
 	                <tr>
 	                <form action="editVehicle.do" class="frmBx" method="post">
 	                <%-- <input type="hidden" id="campaign" class="form-control" name="campaign" placeholder="campaign" value="${allVehicle.getCampaign()}">
               --%>
 	                <td name="vehicle_id">
 	                ...
 	                <td name="owner_name"><input type="hidden" id="vehicleId" class="form-control" name="owner_name" placeholder="owner_name" value="<c:out value="${allVehicle.getOwner_name()}"/>">
 	                <c:out value="${allVehicle.getOwner_name()}"/></td>
                        <td name="vehicle_number"><c:out value="${allVehicle.getVehicle_number()}"/></td>
                        <td name="start_location">
                        <c:out value="${allVehicle.getStart_location()}"/>
                        </td>
                          <%-- <c:out value="${allVehiclePartner.getCampaign_name()}"/></td> --%>
  	                    <td name="delivery_location"><c:out value="${allVehicle.getDelivery_location()}"/></td>
  	                    <td name="platform"><c:out value="${allVehicle.getPlatform()}"/></td>
  	                    <td name="shift"><c:out value="${allVehicle.getShift()}"/></td>
  	                    <td name="status"> <c:out value="${allVehicle.getStatus()}"/></td>
