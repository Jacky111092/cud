                ...
                <div class="navbar-header">
                    ...
                    <nav class="collapse navigation navbar-collapse navbar-right" role="navigation">
                        <ul id="nav" class="nav navbar-nav">
                            <!-- <li><a href="home2exist">Home</a></li> -->
...
<a href="payment.do"><button class="button" style="margin-top:3%" >Pay</button></a>
<a href="home2exist.jsp"><button class="button" style="margin-top:3%" >No</button></a>
