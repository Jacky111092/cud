                ...
                <div class="navbar-header">
                    ...
                    <ul id="nav" class="nav navbar-nav">
                            ...
                            <li><a href="Renew.html">Renew</a></li>
                                <li><a href="chooseplan2">Choose Plan</a></li>                                                   <li><a href="#pricing">Pricing</a></li>   
                            <li><a href="#contact">Contact</a></li>
                               <li><a href="Tracksatus.html">Track Status</a></li> -->
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active"  style="background-image: url('img/b1.jpg')" >
                        <div class="carousel-caption">
                            <div class="animated bounceInRight" style="margin-left:10%">
                                <h2>Your payment was successful <br></h2>
                                <h3>Please press the button to continue <br>
                                <a href="home2exist.jsp"><button class="button" >Continue</button></a>
