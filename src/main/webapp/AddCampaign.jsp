  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card card-primary">
        ...
        <form action="addCampaign.do" class="frmBx" method="post"  autocomplete="off"><!-- enctype="multipart/form-data" -->
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-4">
              <div class="form-group">
                  ...
                  <input type="text" id="campaign_name" class="form-control" name="campaign_name" placeholder="Campaign Name">
              </div>
            </div>
            <div class="col-12 col-md-4">
              <div class="form-group">
                  <label for="no_of_kilometres">No. of kilometres</label>
                  <input type="number" id="no_of_kilometres" class="form-control" name="no_of_kilometres" placeholder="No. of kilometres">
              </div>
            </div>
            <div class="col-12 col-md-4">
              <div class="form-group">
                  <label for="rate">Rate/Kilometre</label>
                  <input type="number" id="rate" class="form-control" name="rate" placeholder="Rate/Kilometre">
              </div>
            </div>
            <script>
            function myFunction() {
                var y = document.getElementById("no_of_kilometres").value;
            ...
            <label for="amount">Amount</label>
              ...
              <input type="number"  class="form-control" id="amount" name="amount" required onclick="myFunction()">
               <input type="button" onClick="myFunction()" Value="Get Budget" />
                </div>
            </div>
            <div class="col-12 col-md-4">
              <div class="form-group">
                  <label for="no_of_vehicles">No of Vehicles</label>
                  <input type="number" class="form-control" name="no_of_vehicles" id="no_of_vehicles" placeholder="No of Vehicles">
                </div>
            </div>
            <div class="col-12 col-md-4">
              <div class="form-group">
             ...
             <div class="col-12 col-md-4">
              <div class="form-group">
                  ...
                  <input type="date" path="start_date" class="form-control" name = "start_date" value = "<fmt:formatDate value="${cForm.start_date}" pattern="yyyy-mm-dd" />" required>
            ...
            <div class="col-12 col-md-4">
              <div class="form-group">
                  ...
                  <input type="date" path="end_date" class="form-control" name = "end_date" value = "<fmt:formatDate value="${cForm.end_date}" pattern="yyyy-mm-dd" />" required>
