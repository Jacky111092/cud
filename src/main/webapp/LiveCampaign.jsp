          ...
          // edit the row
           ...
           <div class="card card-primary" style="width:100%;"> 
            <div class="card-header">
                <h3 class="card-title">List of Live Campaigns</h3>
              </div>
             <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <c:forEach items="${allCampaignList}" var="allCampaign">
 	                <tr>
 	                <form action="editVehiclesForCampaign.do" class="frmBx" method="post">
 	                <td name="campaign_id">
 	                ...
 	                <c:out value="${allCampaign.getCampaignId()}"/></td>
                        ...
                        <td name="campaign_name">
  	                    ...
  	                    <td>
  	                    	<button type="submit" class="btn btn-primary" name ="edit" value="edit">Edit Vehicles</button>
  	                    	
  	                    </td>
  	                    <td>
  	                    	<button type="submit" class="btn btn-primary" name ="editCampaign" value="editCampaign">Edit Campaign</button>
