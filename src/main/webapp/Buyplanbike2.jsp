...
function isValidNumber(){
  var pattern = "[A-Z]{2}\s[0-9|\s]{1,2}\s[A-Z|\s]{1,2}\s[0-9]{1,4}";
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active"  style="background-image: url('img/b1.jpg')" >
                        <div class="carousel-caption">
                            ...
                            <<form action="buyplan.do" method="POST">
                                  <label for="fname">Enter Registration Number</label>
  <input type="text" id="fname" name="regId" placeholder="Enter Registration No...." style="color:black" pattern="[A-Z]{2}[0-9|]{1,2}[A-Z|]{1,2}[0-9]{1,4}" required>
<button class="button" style="margin-left:30%" >Get Quote</button>
                                </form>
                               <p>  </p>
                            </div>
                        </div>
