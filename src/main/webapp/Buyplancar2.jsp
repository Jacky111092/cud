 ...
 <section id="home">     
            <div id="home-carousel" class="carousel slide" data-interval="false">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active"  style="background-image:  url('img/b2.jpg')" >
                        <div class="carousel-caption">
                            <div class="animated bounceInRight">
                            <form action="quote2.html" method="POST">
                                  <label for="fname">Enter Registration Number</label>
  <input type="text" id="fname" name="fname" placeholder="Enter Registration No...." style="color:black" pattern="[A-Z]{2}[0-9|]{1,2}[A-Z|]{1,2}[0-9]{1,4}" >
