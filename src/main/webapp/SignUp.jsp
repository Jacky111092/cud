...
@media(min-width:768px) {
    ...
    <body onload = "document.getElementById('id05').style.display='block'" style="width:auto;">
                    ...
                    <nav class="collapse navigation navbar-collapse navbar-right" role="navigation">
                        <ul id="nav" class="nav navbar-nav">
                           ...
                           <li><a href="#subscribe">Subscribe</a></li>
                            ...
                            <li><a href="#" onclick="document.getElementById('id05').style.display='block'" style="width:auto;">Sign Up</a></li>
                        </ul>
                    </nav>
                    <!-- /main nav -->
                </div>
...
<div id="id05" class="modal2" style="display:flex;">
...
<form action = "register.do" onsubmit="return regForm()" method="post">
<p><font size="3" color="red">${message}</font></p>
<!--<table>
	<tr>
      <td>-->
	  <div class="input">
         <input type="text" name="name" id="uid" placeholder="Full Name" pattern="[A-Za-z\s]+" title="Full Name must be in alphabets only.">
...
<!--      </td>
	  ...
	  <div class="input">
         <input type="text" name="phoneno" id="contact" placeholder="Contact" pattern="[0-9]+" title="Contact must be in Digits only.">
         <span class="spin"></span>
      </div>
      ...
      <div class="input">
          <select name="questionid" class="input drop">
			<option value="101">What is your Favourite Color?</option>
			<option value="102">Which is your best company?</option>
		  </select>
      </div>
      <div class="input">
         <input type="text" name="answer" id="answer" placeholder="Security Answer">
         <span class="spin"></span>
      </div>
	  
     
	  <div class="button login">
         <button><span>SIGN UP</span> <i class="fa fa-check"></i></button>
      </div>
      </form>
