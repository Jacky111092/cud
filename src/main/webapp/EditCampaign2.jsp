            ...
            <div class="col-12 col-md-4">
             ...
             <div class="col-12 col-md-4">
              <div class="form-group">
                  ...
                  <input type="date" path="start_date" class="form-control" name = "start_date" value = "<fmt:formatDate value="${campaignDetails.getStart_date()}" pattern="yyyy-mm-dd" />" readonly="true">
 ...
 --%>                </div>
            ...
            <div class="col-12 col-md-4">
              <div class="form-group">
                  ...
                  <input type="date" path="end_date" class="form-control" name = "end_date" value = "<fmt:formatDate value="${campaignDetails.getEnd_date()}" pattern="yyyy-mm-dd" />" readonly="true">
 ...
 --%>                </div>
         ...
         <div class="col-12 col-md-4">
              <div class="form-group">
                  ...
                  <div class="select2-purple">
                      <select class="form-control select2" name="payment_mode" style="width: 100%;" required="true"> 
