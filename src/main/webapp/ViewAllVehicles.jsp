             ...
             <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <c:forEach items="${allVehicleList}" var="allVehicle">
 	                ...
 	                <td name="vehicle_id">
 	                <input type="hidden" id="vehicle_id" class="form-control" name="vehicle_id" placeholder="vehicle_id" value="<c:out value="${allVehicle.getVehicleId()}"/>">
 	                <c:out value="${allVehicle.getVehicleId()}"/></td>
                        <td name="vehicle_number"><c:out value="${allVehicleList.getVehicle_number()}"/></td>
                        <td name="start_location">
                        <c:out value="${allVehicle.getStart_location()}"/>
                        </td>
                          <%-- <c:out value="${allVehiclePartner.getCampaign_name()}"/></td> --%>
  	                    <td name="delivery_location"><c:out value="${allVehicle.getStart_location()}"/></td>
