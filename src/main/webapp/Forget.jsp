...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body onload = "document.getElementById('id02').style.display='block'" style="width:auto;">
                    ...
                    <nav class="collapse navigation navbar-collapse navbar-right" role="navigation">
                        <ul id="nav" class="nav navbar-nav">
                           ...
                           <li><a href="#subscribe">Subscribe</a></li>
                            ...
                            <li><a href="#" onclick="document.getElementById('id02').style.display='block'" style="width:auto;">LOGIN</a></li>
                        </ul>
                    </nav>
                    <!-- /main nav -->
                </div>
...
<div id="id02" class="modal3">
		...
		<div class="materialContainer">
		   ...
		   <div class="box">
			  ...
			  <div>Answer this security question.</div>
	  <div>
      <span onclick="document.getElementById('id02').style.display='none'" class="close" title="Close Modal">&times;</span>
    </div>
		<form action ="reset.do" onsubmit="return validateForm()" method="post">
		<br>
     <p><font size="1" color="red">${invalidmessage}</font></p>

			  <div class="input">
				 <input type="email" name="emailid" id="question" placeholder="What is your emailid?">
