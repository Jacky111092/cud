...
/*				if(regex.test(uid)==false)
				{
					alert("Username cannot contain digits or any special characters.");
					return false;
				}*/
				if(c.length!=10)
				{
					alert("Contact Number can be only 10 digits.");
					return false;
				}
				if(a==null || a=="")
				{
				...
				if(p.length>12 || p.length<7)
				{
					alert("Length of Password must be between 7 to 12.");
					return false;
				}
