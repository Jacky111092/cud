    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="#">Vehicle Partner</a></li>
          <li class="breadcrumb-item active">All Vehicle Partner</li>
        </ol>
      </div>
    </div>
  </div>
          ...
          // edit the row
           ...
           <div class="card card-primary" style="width:100%;"> 
            <div class="card-header">
                <h3 class="card-title">List of All Vehicle Partners</h3>
              </div>
             <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                   <th> <strong>Vehicle Partner Id</strong></th>
                  ...
                  <c:forEach items="${allVehiclePartnerList}" var="allVehiclePartner">
 	                <tr>
 	                <form action="editVehiclePartner.do" class="frmBx" method="post">
 	                <td name="campaign_id">
 	                <input type="hidden" id="vehicle_partner_id" class="form-control" name="vehicle_partner_id" placeholder="vehicle_partner_id" value="<c:out value="${allVehiclePartner.getVehicle_partner_id()}"/>">
 	                <c:out value="${allVehiclePartner.getVehicle_partner_id()}"/></td>
                        <td name="company_name"><c:out value="${allVehiclePartner.getCompany_name()}"/></td>
                        <td name="no_of_vehicles">
                        <c:out value="${allVehiclePartner.getVehicle_count()}"/>
                        </td>
                          <%-- <c:out value="${allVehiclePartner.getCampaign_name()}"/></td> --%>
  	                    <td name="company_contact_person"><c:out value="${allVehiclePartner.getCompany_contact_person_contact()}"/></td>
  	                    <td name="status"> <c:out value="${allVehiclePartner.getStatus()}"/></td>
