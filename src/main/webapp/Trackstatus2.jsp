...
th, td,tr {
  ...
  <h1 style="margin-bottom:20px"><center><b>Track Your Claim Details</b></center></h1>                             
<table style="width:100%" border="2px solid black">
  ...
  <c:forEach items="${claim}" var="claim">
   ...
   <tr>
        ...
        <td> <c:out value="${claim.getPolicy().getVehicleRegistry().getRegId()}"/></td>
        <td> <c:out value="${claim.getStatus()}"/></td>
</tr>
