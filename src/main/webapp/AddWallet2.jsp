  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card card-primary">
        ...
        <form action="updateWalletForClientCampaign.do" class="frmBx" method="post"  autocomplete="off"><!-- enctype="multipart/form-data" -->
        <!-- <input type="hidden" name="_token" value="{{ csrf_token() }}"> -->
          ...
          <div class="row">
           ...
           <input type="hidden" id="client_id" class="form-control" name="client_id" placeholder="client_id" value="${CampaignDetails.getClient().getClient_id()}">
            
            <div class="col-12 col-md-4">
              <div class="form-group">
                  <label for="for_client_id">Select Client</label>
                  <input type="text" class="form-control" name="company_name" id="company_name" value="${CampaignDetails.getCompany_name()}" readonly="true">
              </div>
            </div>
            <div class="col-12 col-md-4">
              <div class="form-group">
                  <label for="for_campaign_id">Select Campaign</label>
            ...
            <div class="col-12 col-md-4">
              <div class="form-group">
                  <label for="amount">Budget for Campaign</label>
                  <input type="number" class="form-control" name="amount" id="amount" value="${CampaignDetails.getAmount()}" readonly="true">
              </div>
            </div>
             <div class="col-12 col-md-4">
              <div class="form-group">
                  <label for="paid_amount">Amount paying for Campaign</label>
                  <input type="number" id="paid_amount" class="form-control" name="paid_amount" placeholder="Enter amount to pay right now">
              </div>
            </div>
            <div class="col-12 col-md-4">
              <div class="form-group">
                  <label for="payment_type">Payment Type</label>
                  <select class="form-control select2" name="payment_type" id="payment_type" style="width: 100%;">
            ...
            <!-- <div class="col-12 col-md-4">
              <div class="form-group">
                  ...
                  <input type="text" id="payment_details" class="form-control" name="payment_details" placeholder="Payment Details">
              </div>
            </div> -->
            <div class="col-12 col-md-4">
              <div class="form-group">
            ...
            <div class="col-12 col-md-4">
              <div class="form-group">
                  <label for="account_number">Bank Account No</label>
