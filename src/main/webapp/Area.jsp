  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card card-primary">
        ...
        <form action="addArea.do" class="frmBx" method="post" autocomplete="off">
              ...
              <div class="form-group">
                  ...
                  <select class="form-control select2" name="zone_name" style="width: 100%;">
		                    <option selected="selected" disabled="disabled">Zone Name</option>
                  			...
                  			<option>${allZone.getZone_name()}</option>
                  			</c:forEach>
                  			</select>
          ...
          <tbody>
           <c:forEach items="${allAreaList}" var="allArea">
				...
				<form action="editArea.do" class="frmBx" method="post">
                  ...
                  <td><input type="hidden" id="area_id" class="form-control" name="area_id"  value="<c:out value="${allArea.getArea_id()}"/>">
